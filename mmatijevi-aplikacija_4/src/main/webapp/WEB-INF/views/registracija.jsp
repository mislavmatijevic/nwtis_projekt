    ...
    <div class="text-center">
        ...
        <form method="POST" style="margin: auto; max-width: 500px">
            <div class="form-outline mb-4">
                ...
                <input name="korime" type="text" id="korime" class="form-control" value="${korime}"/>
            </div>

            <div class="form-outline mb-4">
                <label class="form-label" for="ime">Ime</label>
                <input name="ime" type="text" id="ime" class="form-control" value="${ime}"/>
            </div>

            <div class="form-outline mb-4">
                <label class="form-label" for="prezime">Prezime</label>
                <input name="prezime" type="text" id="prezime" class="form-control" value="${prezime}"/>
            </div>

            <div class="form-outline mb-4">
                <label class="form-label" for="lozinka">Lozinka</label>
                <input name="lozinka" type="password" id="lozinka" class="form-control" value="${lozinka}"/>
            </div>
            ...
            <div class="text-center">
                <p>Registraciju obavlja korisnik sustava '${sustavKorisnik}'</p>
            </div>
        </form>
    </div>
</body>
